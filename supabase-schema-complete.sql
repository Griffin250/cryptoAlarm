...
-- Create RLS policies for alert conditions
...
-- Create RLS policies for alert notifications
...
-- Create RLS policies for alert logs
...
VALUES 
  ...
  ('BNBUSDT', '1h', NOW() - INTERVAL '1 hour', 620, 635, 615, 628, 2100.3);