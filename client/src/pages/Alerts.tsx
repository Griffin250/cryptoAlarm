...
interface Alert {
  ...
  notificationMethod: 'phone' | 'email' | 'both'
  currentPrice: number
  createdAt: string
              ...
              <form onSubmit={handleCreateAlert} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: 'price' | 'percentage') => setNewAlert(prev => ({ ...prev, alertType: value }))}
                    >
                      <SelectTrigger className="bg-gray-800/50 border-gray-600 text-white">
                        <SelectValue />
                      </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value: 'phone' | 'email' | 'both') => setNewAlert(prev => ({ ...prev, notificationMethod: value }))}
                  >
                    <SelectTrigger className="bg-gray-800/50 border-gray-600 text-white">
                      <SelectValue />
                    </SelectTrigger>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-white font-medium">
                        {alert.alertType === 'price' 
                          ? `Target: $${parseFloat(alert.targetPrice || '0').toLocaleString()}`
